...
const blogRoutes = require('./routes/blogRoutes') //using express router from lesson 9
...
app.set('view engine', 'ejs');
 ...
 app.use(express.urlencoded({ extended: true })); // this basically takes all the url encoded data that along for a ride (from the url), and passes it into an object that we can use on a request object.
